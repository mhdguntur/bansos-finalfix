...
<body>
    ...
    <div class="container" style="padding-bottom: 475px;">
        @yield('content')
    </div>
    ...
    <script>
        ...
        function ubah_tgl() {
            const tgl_pelayanan = document.querySelector("#tgl_pelayanan").value;
            const tanggal = document.querySelector("#tanggal");

            tanggal.innerHTML = tgl_pelayanan;
        }
    </script>
